function Logo() {
    return (
        <div className="logo flex items-center space-x-4 p-4">
            ...
            <div className="home-icon bg-zinc-900 w-10 h-10 rounded-full flex items-center justify-center hover:bg-zinc-700 hover:scale-110 transition duration-300">
                <svg data-encore-id="icon" role="img" aria-hidden="true" className="fill-[#b3b3b3] w-[24px] h-[24px]" viewBox="0 0 24 24">
